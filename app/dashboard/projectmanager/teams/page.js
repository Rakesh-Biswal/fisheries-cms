...
import HireWorkerForm from "@/components/PM_Component/HireNewWorker"; // ✅ import your form
...
export default function TeamsPage() {
  ...
  const handleView = (employeeId) => {
    router.push(`/dashboard/projectmanager/teams/${employeeId}/view`);
  };

  const handleEdit = (employeeId) => {
    router.push(`/dashboard/projectmanager/teams/${employeeId}/edit`);
  };

  const handleDelete = (employeeId) => {
    router.push(`/dashboard/projectmanager/teams/${employeeId}/delete`);
  };
