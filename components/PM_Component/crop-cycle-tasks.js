...
export default function CropCycleTasks() {
  ...
  return (
    <Card className="bg-white">
      <CardHeader>
        <CardTitle className="text-base lg:text-lg font-semibold text-gray-900">Crop Cycle Tasks</CardTitle>
        ...
        <div className="space-y-4">
          ...
          <div className="hidden lg:block">
            <div className="space-y-3">
              ...
              {tasks.map((task) => (
                <div key={task.id} className="grid grid-cols-12 gap-4 items-center py-3 border-b border-gray-100">
                  ...
                  <div className="col-span-3">
                    <Badge
                      ...
                      className={
                        task.status === "Approved" ? "bg-green-100 text-green-800" : "bg-blue-100 text-blue-800"
                      }
                    >
                      {task.status}
                    </Badge>
            ...
            {tasks.map((task) => (
              <div key={task.id} className="border border-gray-200 rounded-lg p-4">
                ...
                <div className="flex items-center justify-between">
                  <Badge
                    variant={task.status === "Approved" ? "default" : "secondary"}
                    className={task.status === "Approved" ? "bg-green-100 text-green-800" : "bg-blue-100 text-blue-800"}
                  >
                    {task.status}
                  </Badge>
                  <Button variant="ghost" size="sm">
