// components/WorkModeTrackerPM.js
"use client"
...
export default function WorkModeTracker() {
  ...
  const checkTodayAttendance = async () => {
    try {
      setLoading(true)
      const response = await fetch(`${API_URL}/api/pm/attendance/today`, {
        credentials: 'include'
      })
  ...
  const handleWorkModeOn = async () => {
    try {
      ...
      const response = await fetch(`${API_URL}/api/pm/attendance/work-mode-on`, {
        method: 'POST',
        headers: {
  ...
  const handleWorkModeOff = async () => {
    try {
      ...
      const response = await fetch(`${API_URL}/api/pm/attendance/work-mode-off`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
