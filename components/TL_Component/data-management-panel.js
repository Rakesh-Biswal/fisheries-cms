...
export default function DataManagementPanel({ onDataUpdate }) {
  ...
  const handleUpdateHarvest = () => {
    if (harvestData.value && harvestData.estimated) {
      updateCurrentHarvestValue(
        Number.parseInt(harvestData.value),
        Number.parseInt(harvestData.estimated)
      );
      onDataUpdate?.();
  ...
  const handleUpdateYield = () => {
    if (yieldData.month && yieldData.rental && yieldData.expenses) {
      updateMonthlyYield(
        yieldData.month,
        Number.parseInt(yieldData.rental),
        Number.parseInt(yieldData.expenses)
      );
      onDataUpdate?.();
  ...
  const handleUpdateInputCosts = () => {
    if (inputCostData.value && inputCostData.percentage) {
      updateTotalInputCosts(
        Number.parseInt(inputCostData.value),
        Number.parseFloat(inputCostData.percentage)
      );
      onDataUpdate?.();
  ...
  const handleUpdateCropStatus = () => {
    if (
      cropStatusData.growing &&
      cropStatusData.occupied &&
      cropStatusData.vacant
    ) {
      updateCropStatus(
  ...
  const handleAddProductionData = () => {
    if (
      ...
      productionData.overhead &&
      productionData.maintenance
    ) {
      addProductionCostData(
        productionData.date,
  ...
  const handleAddTask = () => {
    if (taskData.taskName && taskData.address && taskData.compliance) {
      addCropCycleTask(
        taskData.taskName,
        taskData.address,
        Number.parseInt(taskData.compliance),
        taskData.status
      );
      onDataUpdate?.();
      setTaskData({
        ...
        <CardContent className="pt-0">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setHarvestData({ ...harvestData, value: e.target.value })
                    }
                    placeholder="15200"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setYieldData({ ...yieldData, month: e.target.value })
                    }
                    placeholder="Aug"
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setYieldData({ ...yieldData, rental: e.target.value })
                    }
                    placeholder="20000"
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setYieldData({ ...yieldData, expenses: e.target.value })
                    }
                    placeholder="12000"
                  />
                </div>
          ...
          {activeTab === "costs" && (
            <div className="space-y-4">
              ...
              <Button
                onClick={handleUpdateInputCosts}
                className="w-full lg:w-auto"
              >
                Update Input Costs
              </Button>
          ...
          {activeTab === "status" && (
            <div className="space-y-4">
              ...
              <Button
                onClick={handleUpdateCropStatus}
                className="w-full lg:w-auto"
              >
                Update Crop Status
              </Button>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setTaskData({ ...taskData, address: e.target.value })
                    }
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setTaskData({ ...taskData, compliance: e.target.value })
                    }
                    placeholder="10"
                  />
                </div>
