...
export default function HireAccountantForm({ onClose, onSuccess }) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await fetch(`${API_URL}/api/hr/accountants/hire`, {
                method: "POST",
                headers: {
            ...
            if (response.ok) {
                ...
                setModalMessage(`${formData.name} has been successfully added as an Accountant!`)
                ...
                throw new Error(errorData.message || "Failed to hire Accountant")
            }
        } catch (error) {
            console.log(error)
            setModalMessage(error.message || "Failed to hire Accountant. Please try again.")
                        ...
                        <div className="mt-8 mb-4">
                            <div className="flex items-center justify-between relative">
                                {steps.map((step, index) => (
                                    <div
                                        key={step.number}
                                        className="flex flex-col items-center z-10 bg-gradient-to-r from-green-50 to-emerald-50 px-2"
                                    >
                                        <div
                                        ...
                                        <p
                                            className={`text-xs mt-2 text-center font-medium max-w-20 ${currentStep >= step.number ? "text-green-600" : "text-gray-500"
                                                }`}
                                        >
                                            {step.title}
                                        </p>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-gray-500 mt-2 bg-gray-50 p-2 rounded">
                                        Accountant will be asked to change this on first login
                                    </p>
                                </div>
                            </div>
                        )}
                        ...
                        {currentStep === 2 && (
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div
                                        className={`border-2 border-dashed rounded-lg p-6 text-center transition-colors ${formErrors.photo ? "border-red-300 bg-red-50" : "border-gray-300 hover:border-green-400 hover:bg-green-50"}`}
                                    >
                                        ...
                                        <Label htmlFor="photo" className="cursor-pointer">
                                            <span className="text-green-500 hover:text-green-600 font-medium">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="font-medium text-green-900">Bank Account Verification</h4>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            placeholder="e.g., Tax Accounting, Audit, Financial Analysis"
                                            className="h-12 border-gray-300 focus:border-green-500 focus:ring-green-500"
                                        />
                                    </div>
                                    <div className="space-y-2">
