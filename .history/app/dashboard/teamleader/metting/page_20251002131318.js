...
{/* Full Screen Calendar using Div */}
{showCalendar && (
  <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
    {/* Main Calendar Container */}
    <div className="bg-white rounded-xl shadow-2xl w-[95vw] h-[95vh] flex flex-col overflow-hidden">
      {/* Header */}
      <div className="p-6 pb-4 bg-gradient-to-r from-blue-600 to-purple-700 text-white">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white">Meeting Calendar</h2>
              <p className="text-blue-100">View and manage all scheduled meetings</p>
            </div>
          </div>
          <Button 
            variant="ghost" 
      ...
      <div className="p-4 bg-white border-b">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="text-xl font-semibold min-w-[300px] text-center">
              {getDateTitle()}
            </div>
            <Button variant="outline" onClick={() => navigateDate(1)}>
              Next
      ...
      <div className="flex-1 overflow-auto p-6">
        <div className="border rounded-lg overflow-hidden bg-white min-h-[500px]">
          ...
          <div className="divide-y">
            {timeSlots.map(time => (
              <div key={time} className="grid grid-cols-5 min-h-[100px]">
                {/* Time Column */}
