  ...
  <div className="fixed inset-0 z-50 bg-background/80 backdrop-blur-sm">
    ...
    <div className="fixed inset-4 bg-white rounded-xl shadow-2xl border flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-auto p-6">
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm h-full min-h-[600px]">
          {/* Calendar Header */}
    ...
    {selectedMeeting && (
      <div className="absolute right-4 top-4 bottom-4 w-1/3 bg-white rounded-lg border-l shadow-2xl">
