...
export default function MeetingPage() {
  ...
  // Replace your entire Calendar Modal section with this improved version
  ...
  <DialogContent className="max-w-7xl max-h-[95vh] overflow-y-auto p-0">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <DialogDescription className="text-blue-100">
              Comprehensive overview of all scheduled meetings and team availability
            </DialogDescription>
          </div>
        </div>
        <Button 
    ...
    <div className="p-6 bg-white border-b">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
        <div className="flex items-center gap-4">
          ...
          <div className="text-xl font-semibold text-gray-800 min-w-[280px] text-center px-4 py-2 bg-gray-50 rounded-lg">
            {getDateTitle()}
          </div>
          <Button 
            variant="outline" 
    ...
    <div className="p-6">
              ...
              >
                ...
                {meetingRooms.map(room => {
                  ...
                  return (
                    <div 
                      key={room} 
                      className="p-3 border-r last:border-r-0 min-h-[120px] relative bg-white group"
                    >
                        ...
                        return (
                          <div
                            ...
                            className={`mb-2 cursor-pointer transform transition-all duration-200 hover:scale-[1.02] hover:shadow-md ${
                              priorityColors[meeting.priority] || 'border-gray-300'
                            }`}
                            onClick={() => setSelectedMeeting(meeting)}
                          >
                            <div className={`bg-gradient-to-r ${meetingTypeColors[meeting.meetingType] || 'from-gray-500 to-gray-600'} text-white rounded-lg p-3 border-l-4 shadow-sm`}>
                      ...
                      {meetings.length === 0 && (
                        <div className="flex items-center justify-center h-full text-gray-400 group-hover:text-gray-600 transition-colors">
                          <div className="text-center">
                            <div className="w-8 h-8 mx-auto mb-1 rounded-full bg-gray-100 flex items-center justify-center group-hover:bg-gray-200 transition-colors">
      ...
      <div className="mt-6 p-4 bg-gray-50 rounded-lg border">
        <h4 className="font-semibold text-gray-700 mb-3">Meeting Legend</h4>
    ...
    {/* Enhanced Meeting Details Panel */}
    {selectedMeeting && (
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-sm font-semibold">Meeting Info</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>{new Date(selectedMeeting.updatedAt).toLocaleDateString()}</span>
                  </div>
                  <div className="flex justify-between">
