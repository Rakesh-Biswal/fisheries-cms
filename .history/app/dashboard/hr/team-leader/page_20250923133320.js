[file name]: image.png
[file content begin]
Name    Email    Position    Level   Status

TJ    Tanya Johnson    tanya@gmail.com    UX/UX Consultant    Junior    Permanent

RM    Rob Moon    robmoon@gmail.com    Software Engineer    Senior    Permanent

SM    Sophia Miller    sophia@gmail.com    Strategy Consultant    Senior    Permanent

BS    Barbara Sales    barbara@gmail.com    Finance    Mid    Contract
          ...
          {teams.length > 0 && (
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {teams.map(team => (
                  <Card key={team.id} className="hover:shadow-lg transition-shadow border-l-4 border-l-blue-500">
                    <CardHeader className="pb-3">
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <CardDescription className="mt-1">{team.title}</CardDescription>
                        </div>
                      ...
                      <div className="flex items-center gap-3 p-2 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-1">
                            ...
                            <span className="font-medium text-sm">{team.leaderName}</span>
                          </div>
                          <p className="text-xs text-muted-foreground">{team.leaderEmail}</p>
                        </div>
                      </div>
