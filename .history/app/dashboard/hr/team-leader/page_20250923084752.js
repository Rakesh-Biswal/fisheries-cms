...
import { Users, Plus, Target, MapPin, TrendingUp, X, Mail, Phone, Eye } from "lucide-react"
...
export default function TeamLeadersPage() {
  ...
  // Sample employee data matching your image
    ...
    <DashboardLayout>
      {showHireForm ? (
        ...
        <div className="space-y-6 p-6">
          ...
          {/* Team Details Table Section - This is what you wanted */}
          {teams.length > 0 && (
            <div className="mt-8">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    All team members across different teams in tabular format
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="border rounded-lg">
                    <Table>
                      ...
                      <TableBody>
                        ...
                        {teams.flatMap(team => team.members).length === 0 && (
                          <TableRow>
      ...
      <Dialog open={showTeamDetails} onOpenChange={setShowTeamDetails}>
        <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedTeam?.title} - Team Leader: {selectedTeam?.leaderName}
            </DialogDescription>
          </DialogHeader>
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <div>
                    ...
                    <CardDescription>
                      All members of {selectedTeam.name} team
                    </CardDescription>
                  </div>
                  <Button 
                    size="sm" 
