...
export default function HRTM() {
  ...
  // Sample meetings data (you can replace this with API data)
  const meetings = [
    {
      title: "Team Sync",
    ...
    <DashboardLayout>
      <main className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          {/* Schedule Card with Meetings and Tasks Tabs */}
              ...
              <Tabs defaultValue="meetings" className="w-full">
                ...
                <TabsContent value="meetings" className="space-y-4 pt-4">
                  {meetings.map((meeting) => (
                    <div key={meeting.title} className="rounded-lg border border-muted p-4">
                      ...
                      <div className="mt-3 flex items-center justify-between text-sm">
                        ...
                        <div className="flex -space-x-2">
                          {meeting.members.map((member) => (
                            <Avatar key={member.fallback} className="h-7 w-7 ring-2 ring-background">
