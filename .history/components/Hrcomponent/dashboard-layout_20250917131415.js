...
import DashboardLayout from "@/components/Hrcomponent/dashboard-layout"; // adjust path if needed
  ...
  return (
    <DashboardLayout>
      <Head>
        ...
        <meta
          name="description"
          content="HR Dashboard for agricultural business"
        />
      </Head>
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600">
              Monitor and manage team leader performance
            </p>
          </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="space-y-4">
              {[
                { label: "Target Achievement", value: teamLeader.targetAchieved },
                { label: "Team Engagement", value: 85 },
                { label: "Report Submission", value: 92 },
                { label: "Client Satisfaction", value: 78 },
              ].map((item, idx) => (
                <div key={idx}>
