...
export default function SalesEmployeesPage() {
  ...
  const handleViewDetails = (employeeId) => {
    router.push(`/dashboard/hr/salesemployee/profile?id=${employeeId}`)
  }
                      ...
                      <CardHeader className="pb-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <CardDescription>{employee.businessData?.designation || "Sales Executive"}</CardDescription>
                          </div>
                        </div>
                      </CardHeader>
