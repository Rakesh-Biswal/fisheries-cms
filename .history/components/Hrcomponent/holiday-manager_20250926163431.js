...
const ProfessionalAttendanceCalendar = () => {
  ...
  // Get department info
  const getDepartmentInfo = (deptValue) => {
            ...
            <div className="border-t border-gray-200 p-6 bg-gray-50">
              <div className="flex gap-3">
                {isDateUsed ? (
                  <>
                    ...
                    <button
                      ...
                      className="px-4 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-medium flex items-center justify-center gap-2"
                    >
                      <Trash2 size={18} />
                    </button>
                  </>
                ...
                <button
                  ...
                  className="px-4 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400 transition-colors font-medium"
                >
                  <X size={18} />
                </button>
              </div>
