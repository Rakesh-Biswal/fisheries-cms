...
export default function CreateMeetingModal({ open, onOpenChange, onCreateMeeting, departments }) {
  ...
  // Debug: Check what departments data looks like
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex flex-wrap gap-2">
                {departments && departments.length > 0 ? (
                    ...
                    <button
                      ...
                      className={`px-3 py-2 rounded-lg text-sm border transition-colors ${
                        isDepartmentSelected(dept.id)
                          ? `${dept.color || 'bg-blue-500'} text-white border-transparent`
                  ...
                  <div className="text-sm text-gray-500 p-2">
                    No departments available. Please check if the departments API is working.
                  </div>
                )}
              </div>
          ...
          <div className="flex gap-3 justify-end pt-4 border-t">
            ...
            <Button 
              type="submit" 
              disabled={loading || !formData.title || !formData.schedule.date || !formData.schedule.startTime || !formData.schedule.endTime}
            >
              {loading ? (
                <>
